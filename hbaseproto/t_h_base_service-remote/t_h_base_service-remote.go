...
func main() {
  ...
  client := hbaseproto.NewTHBaseServiceClientFactory(trans, protocolFactory)
  ...
  case "existsAll":
    ...
    containerStruct1 := hbaseproto.NewTHBaseServiceExistsAllArgs()
  ...
  case "getMultiple":
    ...
    containerStruct1 := hbaseproto.NewTHBaseServiceGetMultipleArgs()
  ...
  case "putMultiple":
    ...
    containerStruct1 := hbaseproto.NewTHBaseServicePutMultipleArgs()
  ...
  case "deleteSingle":
    ...
    argvalue1 := hbaseproto.NewTDelete()
  ...
  case "deleteMultiple":
    ...
    containerStruct1 := hbaseproto.NewTHBaseServiceDeleteMultipleArgs()
  ...
  case "checkAndDelete":
    ...
    argvalue5 := hbaseproto.NewTDelete()
  ...
  case "increment":
    ...
    argvalue1 := hbaseproto.NewTIncrement()
  ...
  case "append":
    ...
    argvalue1 := hbaseproto.NewTAppend()
  ...
  case "mutateRow":
    ...
    argvalue1 := hbaseproto.NewTRowMutations()
  ...
  case "checkAndMutate":
    ...
    argvalue4 := hbaseproto.TCompareOp(tmp4)
    value4 := argvalue4
    ...
    argvalue6 := hbaseproto.NewTRowMutations()
